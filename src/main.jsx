  ...
  return <section className="hero" id="top">
    ...
    <div className="container hero-grid">
      <div className="hero-copy reveal">
        ...
        <div className="hero-price"><span>Digital eBook</span><strong>{PRODUCT.price}</strong></div>
...
function Product() {
  ...
  return <section className="section dark product" id="purchase" data-reveal><div className="container product-grid"><div className="product-copy"><p className="eyebrow">EVERYTHING INCLUDED FOR {PRODUCT.price}</p><h2>What you'll<br /><em>get.</em></h2><p className="lead">A digital book built to be read, used and returned to.</p><ul className="check-list">{included.map(item => <li key={item}><span>✓</span>{item}</li>)}</ul></div><div className="purchase-card"><img className="purchase-cover" src={PRODUCT.coverImage} alt="The Gita for Modern Life eBook cover" loading="lazy" /><div className="card-kicker">THE GITA FOR MODERN LIFE</div><h3>{PRODUCT.subtitle}</h3><div className="price">{PRODUCT.price}</div><p className="purchase-format">Digital product · English · Instant access after purchase</p><CheckoutLink dataCta="pricing" className="button button-gold button-wide">GET THE EBOOK <span>↗</span></CheckoutLink><p className="secure">You'll be redirected to SuperProfile to complete your purchase.<br />Checkout powered by SuperProfile.</p></div></div></section>;
}
